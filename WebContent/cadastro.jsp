  ...
  <body>
    ...
    <section id="cad">
      <form id="form-cadastro" action="index.jsp">
        <h1 class="title">Cadastro - Informações Pessoais</h1>
        <div class="question">
        ...
        <div class="question">
          <input type="text" name="cpf" id="cpf" placeholder="ex. 999.999.999-99" required />
          <label>CPF</label>
        </div>
        <div class="question">
          <input type="text" name="data_nasc" placeholder="ex. 99/99/9999" id="data_nasc" required />
